...
<section id="wrapper" class="login-register">
  <div class="login-box login-sidebar">
    <div class="white-box">
      <form class="form-horizontal form-material" id="loginform" action="/inicio">
        ...
        <h3 class="box-title m-t-40 m-b-0">Registrarse</h3><small>Crea tu cuenta</small> 
        ...
        <div class="form-group m-b-0">
          <div class="col-sm-12 text-center">
            <p>Ya tienes cuenta? <a href="/inicio" class="text-primary m-l-5"><b>Iniciar sesión</b></a></p>
          </div>
        </div>
      </form>
    </div>
